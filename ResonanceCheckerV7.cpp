...
int main(){
	...
	for(int j = 0; j < NumOfSets; j++){
		...
		//Filling bool arrays for SD selection//
		...
		for(int i = 0; i < NumOfModels; i++){
			...
			if(inFile.good()){
				...
				for(int m = 0; m < NumOfModes; m++){
					...
					double ratio_temp_FU = period_FU/period;
					double ratio_temp_FO = period_FO/period;
					double ratio_temp_2O = period_2O/period;
					double ratio_temp_ThirdO = period_ThirdO/period;
					double ratio_temp_ForthO = period_ForthO/period;
					double ratio_temp_FifthO = period_FifthO/period;
					double ratio_temp_SixthO = period_SixthO/period;
					double ratio_temp_SeventhO = period_SeventhO/period;
					double ratio_temp_EighthO = period_EighthO/period;
					double ratio_temp_NinthO = period_NinthO/period;
