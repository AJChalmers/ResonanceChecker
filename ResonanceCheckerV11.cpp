...
int main(){
	...
	double L_ToLookFor = 50;
	double z_ToLookFor = 0.00135;
	...
	for(int j = 0; j < NumOfSets; j++){
		...
		if(j == 0){
			for(int i = 0; i < NumOfModels; i++){
				if(z[i] = z_ToLookFor && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor && ModelRan_SetA[i]){
					...
					outFile_Fig4_FU_FO<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
				}
			}
		}
		if(j == 1){
			for(int i = 0; i < NumOfModels; i++){
				if(z[i] = z_ToLookFor && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor && ModelRan_SetB[i]){
					...
					outFile_Fig4_FU_FO<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
				}
			}
		}
		if(j == 2){
			for(int i = 0; i < NumOfModels; i++){
				if(z[i] = z_ToLookFor && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor && ModelRan_SetC[i]){
					...
					outFile_Fig4_FU_FO<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
				}
			}
		}
		if(j == 3){
			for(int i = 0; i < NumOfModels; i++){
				if(z[i] = z_ToLookFor && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor && ModelRan_SetD[i]){
					...
					outFile_Fig4_FU_FO<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
				}
			}
		}
	
		outFile_Fig4_FU_FO.close();
