...
//V11: Changed all Fig5 to Fig4 - represents the actual figure number now. Adding option to sort by composition as well? Turn offs for other functions too?

//V12: Moving creation of Fig4 outFiles and enabling creation of all L, z combos being looked at.
...
int main(){
	...
	char ModelGridFileName[50] = "models_linearanalysis_BLH.dat"; //Name of input model grid, used to get values for Fig4, maybe others?
	...
	char SetA_Suffix[10] = "_SetA.dat"; //Suffix to input/output file for SetA (With .dat)
	...
	double L_ToLookFor_1 = 50; //L to look for in the model grid inFile
	double L_ToLookFor_2 = 100; 
	double L_ToLookFor_3 = 150;
	double L_ToLookFor_4 = 200;
	double L_ToLookFor_5 = 250;
	double L_ToLookFor_6 = 300;
	
	double Z_ToLookFor_1 = 0.01300; //z to look for in the model grid inFile
	double Z_ToLookFor_2 = 0.00834;
	double Z_ToLookFor_3 = 0.00424;
	double Z_ToLookFor_4 = 0.00135;
	double Z_ToLookFor_5 = 0.00061;
	double Z_ToLookFor_6 = 0.00043;
	double Z_ToLookFor_7 = 0.00014;
	...
	bool TurnOffResRatio = true; //If true, will turn off ratio calculation along with any output. Fig4 creation still works
	
	///////////////////////////////////////
	
	//Variables//
	int NumOfL = 6; //Number of L values. 6 is max currently
	int NumOfZ = 7; //Number of z values. 7 is max currently
	...
	for(int j = 0; j < NumOfSets; j++){
		...
		char Fig4_FU_FO_FileName_Prefix[50];
		
		char Fig4_FU_FO_FileName_L1_Z1[100];
		char Fig4_FU_FO_FileName_L1_Z2[100];
		char Fig4_FU_FO_FileName_L1_Z3[100];
		char Fig4_FU_FO_FileName_L1_Z4[100];
		char Fig4_FU_FO_FileName_L1_Z5[100];
		char Fig4_FU_FO_FileName_L1_Z6[100];
		char Fig4_FU_FO_FileName_L1_Z7[100];
		
		char Fig4_FU_FO_FileName_L2_Z1[100];
		char Fig4_FU_FO_FileName_L2_Z2[100];
		char Fig4_FU_FO_FileName_L2_Z3[100];
		char Fig4_FU_FO_FileName_L2_Z4[100];
		char Fig4_FU_FO_FileName_L2_Z5[100];
		char Fig4_FU_FO_FileName_L2_Z6[100];
		char Fig4_FU_FO_FileName_L2_Z7[100];
		
		char Fig4_FU_FO_FileName_L3_Z1[100];
		char Fig4_FU_FO_FileName_L3_Z2[100];
		char Fig4_FU_FO_FileName_L3_Z3[100];
		char Fig4_FU_FO_FileName_L3_Z4[100];
		char Fig4_FU_FO_FileName_L3_Z5[100];
		char Fig4_FU_FO_FileName_L3_Z6[100];
		char Fig4_FU_FO_FileName_L3_Z7[100];
		
		char Fig4_FU_FO_FileName_L4_Z1[100];
		char Fig4_FU_FO_FileName_L4_Z2[100];
		char Fig4_FU_FO_FileName_L4_Z3[100];
		char Fig4_FU_FO_FileName_L4_Z4[100];
		char Fig4_FU_FO_FileName_L4_Z5[100];
		char Fig4_FU_FO_FileName_L4_Z6[100];
		char Fig4_FU_FO_FileName_L4_Z7[100];
		
		char Fig4_FU_FO_FileName_L5_Z1[100];
		char Fig4_FU_FO_FileName_L5_Z2[100];
		char Fig4_FU_FO_FileName_L5_Z3[100];
		char Fig4_FU_FO_FileName_L5_Z4[100];
		char Fig4_FU_FO_FileName_L5_Z5[100];
		char Fig4_FU_FO_FileName_L5_Z6[100];
		char Fig4_FU_FO_FileName_L5_Z7[100];
		
		char Fig4_FU_FO_FileName_L6_Z1[100];
		char Fig4_FU_FO_FileName_L6_Z2[100];
		char Fig4_FU_FO_FileName_L6_Z3[100];
		char Fig4_FU_FO_FileName_L6_Z4[100];
		char Fig4_FU_FO_FileName_L6_Z5[100];
		char Fig4_FU_FO_FileName_L6_Z6[100];
		char Fig4_FU_FO_FileName_L6_Z7[100];
		
		ofstream outFile_Fig4_FU_FO_L1_Z1;
		ofstream outFile_Fig4_FU_FO_L1_Z2;
		ofstream outFile_Fig4_FU_FO_L1_Z3;
		ofstream outFile_Fig4_FU_FO_L1_Z4;
		ofstream outFile_Fig4_FU_FO_L1_Z5;
		ofstream outFile_Fig4_FU_FO_L1_Z6;
		ofstream outFile_Fig4_FU_FO_L1_Z7;
		
		ofstream outFile_Fig4_FU_FO_L2_Z1;
		ofstream outFile_Fig4_FU_FO_L2_Z2;
		ofstream outFile_Fig4_FU_FO_L2_Z3;
		ofstream outFile_Fig4_FU_FO_L2_Z4;
		ofstream outFile_Fig4_FU_FO_L2_Z5;
		ofstream outFile_Fig4_FU_FO_L2_Z6;
		ofstream outFile_Fig4_FU_FO_L2_Z7;
		
		ofstream outFile_Fig4_FU_FO_L3_Z1;
		ofstream outFile_Fig4_FU_FO_L3_Z2;
		ofstream outFile_Fig4_FU_FO_L3_Z3;
		ofstream outFile_Fig4_FU_FO_L3_Z4;
		ofstream outFile_Fig4_FU_FO_L3_Z5;
		ofstream outFile_Fig4_FU_FO_L3_Z6;
		ofstream outFile_Fig4_FU_FO_L3_Z7;
		
		ofstream outFile_Fig4_FU_FO_L4_Z1;
		ofstream outFile_Fig4_FU_FO_L4_Z2;
		ofstream outFile_Fig4_FU_FO_L4_Z3;
		ofstream outFile_Fig4_FU_FO_L4_Z4;
		ofstream outFile_Fig4_FU_FO_L4_Z5;
		ofstream outFile_Fig4_FU_FO_L4_Z6;
		ofstream outFile_Fig4_FU_FO_L4_Z7;
		
		ofstream outFile_Fig4_FU_FO_L5_Z1;
		ofstream outFile_Fig4_FU_FO_L5_Z2;
		ofstream outFile_Fig4_FU_FO_L5_Z3;
		ofstream outFile_Fig4_FU_FO_L5_Z4;
		ofstream outFile_Fig4_FU_FO_L5_Z5;
		ofstream outFile_Fig4_FU_FO_L5_Z6;
		ofstream outFile_Fig4_FU_FO_L5_Z7;
		
		ofstream outFile_Fig4_FU_FO_L6_Z1;
		ofstream outFile_Fig4_FU_FO_L6_Z2;
		ofstream outFile_Fig4_FU_FO_L6_Z3;
		ofstream outFile_Fig4_FU_FO_L6_Z4;
		ofstream outFile_Fig4_FU_FO_L6_Z5;
		ofstream outFile_Fig4_FU_FO_L6_Z6;
		ofstream outFile_Fig4_FU_FO_L6_Z7;
		
		string L_ToLookFor_Temp;
		string Z_ToLookFor_Temp;
		//strcpy(Fig4_FU_FO_FileName_Prefix, "ResonanceData_Fig4/");
		strcpy(Fig4_FU_FO_FileName_Prefix, outputFileName);
		strcat(Fig4_FU_FO_FileName_Prefix, "_Fig4");
		
		//Creating all Fig4 file names//
		for(int l = 0; l < NumOfL; l++){
			for(int z = 0; z < NumOfZ; z++){
				//L = 50
				if(l == 0){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L1_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_1;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
							
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_1;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z1<<endl;
							
							outFile_Fig4_FU_FO_L1_Z1.open(Fig4_FU_FO_FileName_L1_Z1, ios::out);
							outFile_Fig4_FU_FO_L1_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L1_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_2;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z2, SetD_Suffix);
							}
		
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z2<<endl;
							
							outFile_Fig4_FU_FO_L1_Z2.open(Fig4_FU_FO_FileName_L1_Z2, ios::out);
							outFile_Fig4_FU_FO_L1_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L1_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_3;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z3<<endl;
							
							outFile_Fig4_FU_FO_L1_Z3.open(Fig4_FU_FO_FileName_L1_Z3, ios::out);
							outFile_Fig4_FU_FO_L1_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L1_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_4;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z4<<endl;
							
							outFile_Fig4_FU_FO_L1_Z4.open(Fig4_FU_FO_FileName_L1_Z4, ios::out);
							outFile_Fig4_FU_FO_L1_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L1_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_5;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z5, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z5<<endl;
							
							outFile_Fig4_FU_FO_L1_Z5.open(Fig4_FU_FO_FileName_L1_Z5, ios::out);
							outFile_Fig4_FU_FO_L1_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L1_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_6;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z6<<endl;
							
							outFile_Fig4_FU_FO_L1_Z6.open(Fig4_FU_FO_FileName_L1_Z6, ios::out);
							outFile_Fig4_FU_FO_L1_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L1_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							streamZ.clear();
							streamZ<<Z_ToLookFor_7;
							Z_ToLookFor_Temp = streamZ.str();
							streamZ.clear();
							
							strcat(Fig4_FU_FO_FileName_L1_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L1_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L1_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L1_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L1_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L1_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L1_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L1_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L1_Z7<<endl;
							
							outFile_Fig4_FU_FO_L1_Z7.open(Fig4_FU_FO_FileName_L1_Z7, ios::out);
							outFile_Fig4_FU_FO_L1_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
				...
				if(l == 1){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L2_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_2;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z1<<endl;
							
							outFile_Fig4_FU_FO_L2_Z1.open(Fig4_FU_FO_FileName_L2_Z1, ios::out);
							outFile_Fig4_FU_FO_L2_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L2_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z2, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z2<<endl;
							
							outFile_Fig4_FU_FO_L2_Z2.open(Fig4_FU_FO_FileName_L2_Z2, ios::out);
							outFile_Fig4_FU_FO_L2_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L2_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z3<<endl;
							
							outFile_Fig4_FU_FO_L2_Z3.open(Fig4_FU_FO_FileName_L2_Z3, ios::out);
							outFile_Fig4_FU_FO_L2_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L2_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z4<<endl;
							
							outFile_Fig4_FU_FO_L2_Z4.open(Fig4_FU_FO_FileName_L2_Z4, ios::out);
							outFile_Fig4_FU_FO_L2_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L2_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z5, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z5<<endl;
							
							outFile_Fig4_FU_FO_L2_Z5.open(Fig4_FU_FO_FileName_L2_Z5, ios::out);
							outFile_Fig4_FU_FO_L2_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L2_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z6<<endl;
							
							outFile_Fig4_FU_FO_L2_Z6.open(Fig4_FU_FO_FileName_L2_Z6, ios::out);
							outFile_Fig4_FU_FO_L2_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L2_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L2_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L2_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L2_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L2_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L2_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L2_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L2_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L2_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L2_Z7<<endl;
							
							outFile_Fig4_FU_FO_L2_Z7.open(Fig4_FU_FO_FileName_L2_Z7, ios::out);
							outFile_Fig4_FU_FO_L2_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
				...
				if(l == 2){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L3_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_3;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z1<<endl;
							
							outFile_Fig4_FU_FO_L3_Z1.open(Fig4_FU_FO_FileName_L3_Z1, ios::out);
							outFile_Fig4_FU_FO_L3_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L3_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z2, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z2<<endl;
							
							outFile_Fig4_FU_FO_L3_Z2.open(Fig4_FU_FO_FileName_L3_Z2, ios::out);
							outFile_Fig4_FU_FO_L3_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L3_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z3<<endl;
							
							outFile_Fig4_FU_FO_L3_Z3.open(Fig4_FU_FO_FileName_L3_Z3, ios::out);
							outFile_Fig4_FU_FO_L3_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L3_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z4<<endl;
							
							outFile_Fig4_FU_FO_L3_Z4.open(Fig4_FU_FO_FileName_L3_Z4, ios::out);
							outFile_Fig4_FU_FO_L3_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L3_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z5, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z5<<endl;
							
							outFile_Fig4_FU_FO_L3_Z5.open(Fig4_FU_FO_FileName_L3_Z5, ios::out);
							outFile_Fig4_FU_FO_L3_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L3_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z6<<endl;
							
							outFile_Fig4_FU_FO_L3_Z6.open(Fig4_FU_FO_FileName_L3_Z6, ios::out);
							outFile_Fig4_FU_FO_L3_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L3_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L3_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L3_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L3_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L3_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L3_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L3_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L3_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L3_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L3_Z7<<endl;
							
							outFile_Fig4_FU_FO_L3_Z7.open(Fig4_FU_FO_FileName_L3_Z7, ios::out);
							outFile_Fig4_FU_FO_L3_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
				...
				if(l == 3){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L4_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_4;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z1<<endl;
							
							outFile_Fig4_FU_FO_L4_Z1.open(Fig4_FU_FO_FileName_L4_Z1, ios::out);
							outFile_Fig4_FU_FO_L4_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L4_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z2, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z2<<endl;
							
							outFile_Fig4_FU_FO_L4_Z2.open(Fig4_FU_FO_FileName_L4_Z2, ios::out);
							outFile_Fig4_FU_FO_L4_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L4_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z3<<endl;
							
							outFile_Fig4_FU_FO_L4_Z3.open(Fig4_FU_FO_FileName_L4_Z3, ios::out);
							outFile_Fig4_FU_FO_L4_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L4_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z4<<endl;
							
							outFile_Fig4_FU_FO_L4_Z4.open(Fig4_FU_FO_FileName_L4_Z4, ios::out);
							outFile_Fig4_FU_FO_L4_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L4_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z5, SetD_Suffix);
							}
						
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z5<<endl;
							
							outFile_Fig4_FU_FO_L4_Z5.open(Fig4_FU_FO_FileName_L4_Z5, ios::out);
							outFile_Fig4_FU_FO_L4_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L4_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z6<<endl;
							
							outFile_Fig4_FU_FO_L4_Z6.open(Fig4_FU_FO_FileName_L4_Z6, ios::out);
							outFile_Fig4_FU_FO_L4_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L4_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L4_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L4_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L4_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L4_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L4_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L4_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L4_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L4_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L4_Z7<<endl;
							
							outFile_Fig4_FU_FO_L4_Z7.open(Fig4_FU_FO_FileName_L4_Z7, ios::out);
							outFile_Fig4_FU_FO_L4_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
				...
				if(l == 4){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L5_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_5;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z1<<endl;
							
							outFile_Fig4_FU_FO_L5_Z1.open(Fig4_FU_FO_FileName_L5_Z1, ios::out);
							outFile_Fig4_FU_FO_L5_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L5_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z2, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z2<<endl;
							
							outFile_Fig4_FU_FO_L5_Z2.open(Fig4_FU_FO_FileName_L5_Z2, ios::out);
							outFile_Fig4_FU_FO_L5_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L5_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z3<<endl;
							
							outFile_Fig4_FU_FO_L5_Z3.open(Fig4_FU_FO_FileName_L5_Z3, ios::out);
							outFile_Fig4_FU_FO_L5_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L5_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z4<<endl;
							
							outFile_Fig4_FU_FO_L5_Z4.open(Fig4_FU_FO_FileName_L5_Z4, ios::out);
							outFile_Fig4_FU_FO_L5_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L5_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z5, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z5<<endl;
							
							outFile_Fig4_FU_FO_L5_Z5.open(Fig4_FU_FO_FileName_L5_Z5, ios::out);
							outFile_Fig4_FU_FO_L5_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L5_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z6<<endl;
							
							outFile_Fig4_FU_FO_L5_Z6.open(Fig4_FU_FO_FileName_L5_Z6, ios::out);
							outFile_Fig4_FU_FO_L5_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L5_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L5_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L5_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L5_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L5_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L5_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L5_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L5_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L5_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L5_Z7<<endl;
							
							outFile_Fig4_FU_FO_L5_Z7.open(Fig4_FU_FO_FileName_L5_Z7, ios::out);
							outFile_Fig4_FU_FO_L5_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
				...
				if(l == 5){
					if(z == 0){
						strcpy(Fig4_FU_FO_FileName_L6_Z1, Fig4_FU_FO_FileName_Prefix);
						
						stringstream streamL;
							streamL.clear();
							streamL<<L_ToLookFor_6;
							L_ToLookFor_Temp = streamL.str();
							streamL.clear();
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z1, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z1, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z1, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z1, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z1, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z1, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z1, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z1, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z1<<endl;
							
							outFile_Fig4_FU_FO_L6_Z1.open(Fig4_FU_FO_FileName_L6_Z1, ios::out);
							outFile_Fig4_FU_FO_L6_Z1<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 1){
						strcpy(Fig4_FU_FO_FileName_L6_Z2, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z2, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z2, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z2, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z2, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z2, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z2, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z2, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z2, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z2<<endl;
							
							outFile_Fig4_FU_FO_L6_Z2.open(Fig4_FU_FO_FileName_L6_Z2, ios::out);
							outFile_Fig4_FU_FO_L6_Z2<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 2){
						strcpy(Fig4_FU_FO_FileName_L6_Z3, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z3, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z3, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z3, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z3, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z3, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z3, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z3, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z3, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z3<<endl;
							
							outFile_Fig4_FU_FO_L6_Z3.open(Fig4_FU_FO_FileName_L6_Z3, ios::out);
							outFile_Fig4_FU_FO_L6_Z3<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 3){
						strcpy(Fig4_FU_FO_FileName_L6_Z4, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z4, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z4, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z4, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z4, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z4, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z4, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z4, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z4, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z4<<endl;
							
							outFile_Fig4_FU_FO_L6_Z4.open(Fig4_FU_FO_FileName_L6_Z4, ios::out);
							outFile_Fig4_FU_FO_L6_Z4<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 4){
						strcpy(Fig4_FU_FO_FileName_L6_Z5, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z5, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z5, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z5, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z5, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z5, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z5, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z5, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z5, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z5<<endl;
							
							outFile_Fig4_FU_FO_L6_Z5.open(Fig4_FU_FO_FileName_L6_Z5, ios::out);
							outFile_Fig4_FU_FO_L6_Z5<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 5){
						strcpy(Fig4_FU_FO_FileName_L6_Z6, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z6, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z6, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z6, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z6, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z6, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z6, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z6, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z6, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z6<<endl;
							
							outFile_Fig4_FU_FO_L6_Z6.open(Fig4_FU_FO_FileName_L6_Z6, ios::out);
							outFile_Fig4_FU_FO_L6_Z6<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
	
					}
					if(z == 6){
						strcpy(Fig4_FU_FO_FileName_L6_Z7, Fig4_FU_FO_FileName_Prefix);
						...
						stringstream streamZ;
							...
							strcat(Fig4_FU_FO_FileName_L6_Z7, "_L");
							strcat(Fig4_FU_FO_FileName_L6_Z7, L_ToLookFor_Temp.c_str());
							strcat(Fig4_FU_FO_FileName_L6_Z7, "_Z");
							strcat(Fig4_FU_FO_FileName_L6_Z7, Z_ToLookFor_Temp.c_str());
							if(j == 0){
								strcat(Fig4_FU_FO_FileName_L6_Z7, SetA_Suffix);
							}
							if(j == 1){
								strcat(Fig4_FU_FO_FileName_L6_Z7, SetB_Suffix);
							}
							if(j == 2){
								strcat(Fig4_FU_FO_FileName_L6_Z7, SetC_Suffix);
							}
							if(j == 3){
								strcat(Fig4_FU_FO_FileName_L6_Z7, SetD_Suffix);
							}
							
							cout<<"Fig4 output file: "<<Fig4_FU_FO_FileName_L6_Z7<<endl;
							
							outFile_Fig4_FU_FO_L6_Z7.open(Fig4_FU_FO_FileName_L6_Z7, ios::out);
							outFile_Fig4_FU_FO_L6_Z7<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
		...
		cout<<"Fig4 file name creation complete, filling..."<<endl;
		
		//outFile_Fig4_FU_FO.open(Fig4_FU_FO_FileName, ios::out);
		//outFile_Fig4_FU_FO<<setw(10)<<"Teff"<<setw(20)<<"freq_FU"<<setw(20)<<"freq_FO"<<setw(20)<<"freq_2O"<<setw(20)<<"freq_ThirdO"<<setw(20)<<"freq_ForthO"<<setw(20)<<"growth_FU"<<setw(20)<<"growth_FO"<<setw(20)<<"growth_2O"<<setw(20)<<"growth_ThirdO"<<setw(20)<<"growth_ForthO"<<endl;
		
		//Filling of Fig4 files//
		if(j == 0){
			for(int i = 0; i < NumOfModels; i++){
				if(ModelRan_SetA[i]){
					//L = 50
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						outFile_Fig4_FU_FO_L1_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L1_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					
					//L = 100
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L2_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					
					//L = 150
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L3_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					
					//L = 200
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L4_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					
					//L = 250
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L5_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					
					//L = 300
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
						
					}
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						double frequency_FU = 1./period_FU_SetA[i];
						double frequency_FO = 1./period_FO_SetA[i];
						double frequency_2O = 1./period_2O_SetA[i];
						double frequency_ThirdO = 1./period_ThirdO_SetA[i];
						double frequency_ForthO = 1./period_ForthO_SetA[i];
						outFile_Fig4_FU_FO_L6_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetA[i]<<setw(20)<<growth_FO_SetA[i]<<setw(20)<<growth_2O_SetA[i]<<setw(20)<<growth_ThirdO_SetA[i]<<setw(20)<<growth_ForthO_SetA[i]<<endl;
			...
			for(int i = 0; i < NumOfModels; i++){
				if(ModelRan_SetB[i]){
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						outFile_Fig4_FU_FO_L1_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L1_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L2_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L3_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L4_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L5_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetB[i];
						double frequency_ForthO = 1./period_ForthO_SetB[i];
						outFile_Fig4_FU_FO_L6_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetB[i]<<setw(20)<<growth_FO_SetB[i]<<setw(20)<<growth_2O_SetB[i]<<setw(20)<<growth_ThirdO_SetB[i]<<setw(20)<<growth_ForthO_SetB[i]<<endl;
			...
			for(int i = 0; i < NumOfModels; i++){
				if(ModelRan_SetC[i]){
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						outFile_Fig4_FU_FO_L1_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L1_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L2_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L3_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L4_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L5_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetC[i];
						double frequency_ForthO = 1./period_ForthO_SetC[i];
						outFile_Fig4_FU_FO_L6_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetC[i]<<setw(20)<<growth_FO_SetC[i]<<setw(20)<<growth_2O_SetC[i]<<setw(20)<<growth_ThirdO_SetC[i]<<setw(20)<<growth_ForthO_SetC[i]<<endl;
			...
			for(int i = 0; i < NumOfModels; i++){
				if(ModelRan_SetD[i]){
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						outFile_Fig4_FU_FO_L1_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_1){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L1_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_2){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L2_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_3){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L3_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_4){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L4_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_5){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L5_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_1 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z1<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_2 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z2<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_3 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z3<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_4 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z4<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_5 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z5<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_6 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z6<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
					...
					if(Z[i] == Z_ToLookFor_7 && Mass[i] == Mass_ToLookFor && L[i] == L_ToLookFor_6){
						...
						double frequency_ThirdO = 1./period_ThirdO_SetD[i];
						double frequency_ForthO = 1./period_ForthO_SetD[i];
						outFile_Fig4_FU_FO_L6_Z7<<setw(10)<<Teff[i]<<setw(20)<<frequency_FU<<setw(20)<<frequency_FO<<setw(20)<<frequency_2O<<setw(20)<<frequency_ThirdO<<setw(20)<<frequency_ForthO<<setw(20)<<growth_FU_SetD[i]<<setw(20)<<growth_FO_SetD[i]<<setw(20)<<growth_2O_SetD[i]<<setw(20)<<growth_ThirdO_SetD[i]<<setw(20)<<growth_ForthO_SetD[i]<<endl;
		...
		outFile_Fig4_FU_FO_L1_Z1.close();
		outFile_Fig4_FU_FO_L1_Z2.close();
		outFile_Fig4_FU_FO_L1_Z3.close();
		outFile_Fig4_FU_FO_L1_Z4.close();
		outFile_Fig4_FU_FO_L1_Z5.close();
		outFile_Fig4_FU_FO_L1_Z6.close();
		outFile_Fig4_FU_FO_L1_Z7.close();
		
		outFile_Fig4_FU_FO_L2_Z1.close();
		outFile_Fig4_FU_FO_L2_Z2.close();
		outFile_Fig4_FU_FO_L2_Z3.close();
		outFile_Fig4_FU_FO_L2_Z4.close();
		outFile_Fig4_FU_FO_L2_Z5.close();
		outFile_Fig4_FU_FO_L2_Z6.close();
		outFile_Fig4_FU_FO_L2_Z7.close();
		
		outFile_Fig4_FU_FO_L3_Z1.close();
		outFile_Fig4_FU_FO_L3_Z2.close();
		outFile_Fig4_FU_FO_L3_Z3.close();
		outFile_Fig4_FU_FO_L3_Z4.close();
		outFile_Fig4_FU_FO_L3_Z5.close();
		outFile_Fig4_FU_FO_L3_Z6.close();
		outFile_Fig4_FU_FO_L3_Z7.close();
		
		outFile_Fig4_FU_FO_L4_Z1.close();
		outFile_Fig4_FU_FO_L4_Z2.close();
		outFile_Fig4_FU_FO_L4_Z3.close();
		outFile_Fig4_FU_FO_L4_Z4.close();
		outFile_Fig4_FU_FO_L4_Z5.close();
		outFile_Fig4_FU_FO_L4_Z6.close();
		outFile_Fig4_FU_FO_L4_Z7.close();
		
		outFile_Fig4_FU_FO_L5_Z1.close();
		outFile_Fig4_FU_FO_L5_Z2.close();
		outFile_Fig4_FU_FO_L5_Z3.close();
		outFile_Fig4_FU_FO_L5_Z4.close();
		outFile_Fig4_FU_FO_L5_Z5.close();
		outFile_Fig4_FU_FO_L5_Z6.close();
		outFile_Fig4_FU_FO_L5_Z7.close();
		
		outFile_Fig4_FU_FO_L6_Z1.close();
		outFile_Fig4_FU_FO_L6_Z2.close();
		outFile_Fig4_FU_FO_L6_Z3.close();
		outFile_Fig4_FU_FO_L6_Z4.close();
		outFile_Fig4_FU_FO_L6_Z5.close();
		outFile_Fig4_FU_FO_L6_Z6.close();
		outFile_Fig4_FU_FO_L6_Z7.close();
