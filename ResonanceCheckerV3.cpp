...
int main(){
	...
	bool DoPosGrowthCut = false; //If true, will only get positive growth models (Still FU will only be positive)
	...
	for(int j = 0; j < NumOfSets; j++){
		...
		if(j == 0){
			if(NumOfFU_SetA > 0){
				outFile_AverageResonance<<"FU Ratio: "<<(OverallResonance_FU_SetA/NumOfFU_SetA)<<"  Number of positive growth models found: "<<NumOfFU_SetA<<endl;
			}
			else(outFile_AverageResonance<<"FU Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFO_SetA > 0){
				outFile_AverageResonance<<"FO Ratio: "<<(OverallResonance_FO_SetA/NumOfFO_SetA)<<"  Number of positive growth models found: "<<NumOfFO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"FO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOf2O_SetA > 0){
				outFile_AverageResonance<<"2O Ratio: "<<(OverallResonance_2O_SetA/NumOf2O_SetA)<<"  Number of positive growth models found: "<<NumOf2O_SetA<<endl;
			}
			else(outFile_AverageResonance<<"2O Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfThirdO_SetA > 0){
				outFile_AverageResonance<<"ThirdO Ratio: "<<(OverallResonance_ThirdO_SetA/NumOfThirdO_SetA)<<"  Number of positive growth models found: "<<NumOfThirdO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"ThirdO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfForthO_SetA > 0){
				outFile_AverageResonance<<"ForthO Ratio: "<<(OverallResonance_ForthO_SetA/NumOfForthO_SetA)<<"  Number of positive growth models found: "<<NumOfForthO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"ForthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFifthO_SetA > 0){
				outFile_AverageResonance<<"FifthO Ratio: "<<(OverallResonance_FifthO_SetA/NumOfFifthO_SetA)<<"  Number of positive growth models found: "<<NumOfFifthO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"FifthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSixthO_SetA > 0){
				outFile_AverageResonance<<"SixthO Ratio: "<<(OverallResonance_SixthO_SetA/NumOfSixthO_SetA)<<"  Number of positive growth models found: "<<NumOfSixthO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"SixthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSeventhO_SetA > 0){
				outFile_AverageResonance<<"SeventhO Ratio: "<<(OverallResonance_SeventhO_SetA/NumOfSeventhO_SetA)<<"  Number of positive growth models found: "<<NumOfSeventhO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"SeventhO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfEighthO_SetA > 0){
				outFile_AverageResonance<<"EighthO Ratio: "<<(OverallResonance_EighthO_SetA/NumOfEighthO_SetA)<<"  Number of positive growth models found: "<<NumOfEighthO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"EighthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfNinthO_SetA > 0){
				outFile_AverageResonance<<"NinthO Ratio: "<<(OverallResonance_NinthO_SetA/NumOfNinthO_SetA)<<"  Number of positive growth models found: "<<NumOfNinthO_SetA<<endl;
			}
			else(outFile_AverageResonance<<"NinthO Ratio: "<<"No positive growth rate models found"<<endl);
		}
		if(j == 1){
			if(NumOfFU_SetB > 0){
				outFile_AverageResonance<<"FU Ratio: "<<(OverallResonance_FU_SetB/NumOfFU_SetB)<<"  Number of positive growth models found: "<<NumOfFU_SetB<<endl;
			}
			else(outFile_AverageResonance<<"FU Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFO_SetB > 0){
				outFile_AverageResonance<<"FO Ratio: "<<(OverallResonance_FO_SetB/NumOfFO_SetB)<<"  Number of positive growth models found: "<<NumOfFO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"FO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOf2O_SetB > 0){
				outFile_AverageResonance<<"2O Ratio: "<<(OverallResonance_2O_SetB/NumOf2O_SetB)<<"  Number of positive growth models found: "<<NumOf2O_SetB<<endl;
			}
			else(outFile_AverageResonance<<"2O Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfThirdO_SetB > 0){
				outFile_AverageResonance<<"ThirdO Ratio: "<<(OverallResonance_ThirdO_SetB/NumOfThirdO_SetB)<<"  Number of positive growth models found: "<<NumOfThirdO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"ThirdO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfForthO_SetB > 0){
				outFile_AverageResonance<<"ForthO Ratio: "<<(OverallResonance_ForthO_SetB/NumOfForthO_SetB)<<"  Number of positive growth models found: "<<NumOfForthO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"ForthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFifthO_SetB > 0){
				outFile_AverageResonance<<"FifthO Ratio: "<<(OverallResonance_FifthO_SetB/NumOfFifthO_SetB)<<"  Number of positive growth models found: "<<NumOfFifthO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"FifthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSixthO_SetB > 0){
				outFile_AverageResonance<<"SixthO Ratio: "<<(OverallResonance_SixthO_SetB/NumOfSixthO_SetB)<<"  Number of positive growth models found: "<<NumOfSixthO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"SixthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSeventhO_SetB > 0){
				outFile_AverageResonance<<"SeventhO Ratio: "<<(OverallResonance_SeventhO_SetB/NumOfSeventhO_SetB)<<"  Number of positive growth models found: "<<NumOfSeventhO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"SeventhO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfEighthO_SetB > 0){
				outFile_AverageResonance<<"EighthO Ratio: "<<(OverallResonance_EighthO_SetB/NumOfEighthO_SetB)<<"  Number of positive growth models found: "<<NumOfEighthO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"EighthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfNinthO_SetB > 0){
				outFile_AverageResonance<<"NinthO Ratio: "<<(OverallResonance_NinthO_SetB/NumOfNinthO_SetB)<<"  Number of positive growth models found: "<<NumOfNinthO_SetB<<endl;
			}
			else(outFile_AverageResonance<<"NinthO Ratio: "<<"No positive growth rate models found"<<endl);
		}
		if(j == 2){
			if(NumOfFU_SetC > 0){
				outFile_AverageResonance<<"FU Ratio: "<<(OverallResonance_FU_SetC/NumOfFU_SetC)<<"  Number of positive growth models found: "<<NumOfFU_SetC<<endl;
			}
			else(outFile_AverageResonance<<"FU Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFO_SetC > 0){
				outFile_AverageResonance<<"FO Ratio: "<<(OverallResonance_FO_SetC/NumOfFO_SetC)<<"  Number of positive growth models found: "<<NumOfFO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"FO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOf2O_SetC > 0){
				outFile_AverageResonance<<"2O Ratio: "<<(OverallResonance_2O_SetC/NumOf2O_SetC)<<"  Number of positive growth models found: "<<NumOf2O_SetC<<endl;
			}
			else(outFile_AverageResonance<<"2O Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfThirdO_SetC > 0){
				outFile_AverageResonance<<"ThirdO Ratio: "<<(OverallResonance_ThirdO_SetC/NumOfThirdO_SetC)<<"  Number of positive growth models found: "<<NumOfThirdO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"ThirdO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfForthO_SetC > 0){
				outFile_AverageResonance<<"ForthO Ratio: "<<(OverallResonance_ForthO_SetC/NumOfForthO_SetC)<<"  Number of positive growth models found: "<<NumOfForthO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"ForthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFifthO_SetC > 0){
				outFile_AverageResonance<<"FifthO Ratio: "<<(OverallResonance_FifthO_SetC/NumOfFifthO_SetC)<<"  Number of positive growth models found: "<<NumOfFifthO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"FifthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSixthO_SetC > 0){
				outFile_AverageResonance<<"SixthO Ratio: "<<(OverallResonance_SixthO_SetC/NumOfSixthO_SetC)<<"  Number of positive growth models found: "<<NumOfSixthO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"SixthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSeventhO_SetC > 0){
				outFile_AverageResonance<<"SeventhO Ratio: "<<(OverallResonance_SeventhO_SetC/NumOfSeventhO_SetC)<<"  Number of positive growth models found: "<<NumOfSeventhO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"SeventhO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfEighthO_SetC > 0){
				outFile_AverageResonance<<"EighthO Ratio: "<<(OverallResonance_EighthO_SetC/NumOfEighthO_SetC)<<"  Number of positive growth models found: "<<NumOfEighthO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"EighthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfNinthO_SetC > 0){
				outFile_AverageResonance<<"NinthO Ratio: "<<(OverallResonance_NinthO_SetC/NumOfNinthO_SetC)<<"  Number of positive growth models found: "<<NumOfNinthO_SetC<<endl;
			}
			else(outFile_AverageResonance<<"NinthO Ratio: "<<"No positive growth rate models found"<<endl);
		}
		if(j == 3){
			if(NumOfFU_SetD > 0){
				outFile_AverageResonance<<"FU Ratio: "<<(OverallResonance_FU_SetD/NumOfFU_SetD)<<"  Number of positive growth models found: "<<NumOfFU_SetD<<endl;
			}
			else(outFile_AverageResonance<<"FU Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFO_SetD > 0){
				outFile_AverageResonance<<"FO Ratio: "<<(OverallResonance_FO_SetD/NumOfFO_SetD)<<"  Number of positive growth models found: "<<NumOfFO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"FO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOf2O_SetD > 0){
				outFile_AverageResonance<<"2O Ratio: "<<(OverallResonance_2O_SetD/NumOf2O_SetD)<<"  Number of positive growth models found: "<<NumOf2O_SetD<<endl;
			}
			else(outFile_AverageResonance<<"2O Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfThirdO_SetD > 0){
				outFile_AverageResonance<<"ThirdO Ratio: "<<(OverallResonance_ThirdO_SetD/NumOfThirdO_SetD)<<"  Number of positive growth models found: "<<NumOfThirdO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"ThirdO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfForthO_SetD > 0){
				outFile_AverageResonance<<"ForthO Ratio: "<<(OverallResonance_ForthO_SetD/NumOfForthO_SetD)<<"  Number of positive growth models found: "<<NumOfForthO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"ForthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfFifthO_SetD > 0){
				outFile_AverageResonance<<"FifthO Ratio: "<<(OverallResonance_FifthO_SetD/NumOfFifthO_SetD)<<"  Number of positive growth models found: "<<NumOfFifthO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"FifthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSixthO_SetD > 0){
				outFile_AverageResonance<<"SixthO Ratio: "<<(OverallResonance_SixthO_SetD/NumOfSixthO_SetD)<<"  Number of positive growth models found: "<<NumOfSixthO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"SixthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfSeventhO_SetD > 0){
				outFile_AverageResonance<<"SeventhO Ratio: "<<(OverallResonance_SeventhO_SetD/NumOfSeventhO_SetD)<<"  Number of positive growth models found: "<<NumOfSeventhO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"SeventhO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfEighthO_SetD > 0){
				outFile_AverageResonance<<"EighthO Ratio: "<<(OverallResonance_EighthO_SetD/NumOfEighthO_SetD)<<"  Number of positive growth models found: "<<NumOfEighthO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"EighthO Ratio: "<<"No positive growth rate models found"<<endl);
			if(NumOfNinthO_SetD > 0){
				outFile_AverageResonance<<"NinthO Ratio: "<<(OverallResonance_NinthO_SetD/NumOfNinthO_SetD)<<"  Number of positive growth models found: "<<NumOfNinthO_SetD<<endl;
			}
			else(outFile_AverageResonance<<"NinthO Ratio: "<<"No positive growth rate models found"<<endl);
		}
